  ...
  return (
    <div className="section-text" data-category="prayers">
      ...
      <p className="section-text__body">
        ...
        Obligatory Prayers (Fard): These are the core prayers Muslims must perform daily. They include Fajr (dawn), Dhuhr (midday), Asr (afternoon), Maghrib (evening), and Isha (night).
        ...
        Remember to seek guidance and perform prayers with sincerity and humility.
      </p>
