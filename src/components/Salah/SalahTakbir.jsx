...
function SalahTakbir({showEnglish}) {
  {if(!showEnglish) {
    return (
    ...
    return (
      <div className="steps-description js-description">
        ...
        <ol className="steps-description__body">
          <li className="steps-description__item">
            While saying <strong>"God is Greater"</strong>, bring your hands down and put your right hand over your left hand
            below the navel, or on the chest. Women on their chest.
          </li>
        </ol>
      </div>
